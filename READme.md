...
- `OCI_CONFIG_CONTENT`        ( Enter /home/ubuntu/.oci/config File Content)
...
12| `OCI_Config_Content`           | `TF_VAR_oci_config_content`      | OCI Config File Content (add `key_file=/home/ubuntu/.oci/config`)                 |
